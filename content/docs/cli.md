...
You can either download CLI binary from our [release page](https://github.com/kudobuilder/kudo/releases) (we produce binaries for both linux and MacOS) or install the CLI plugin using `brew`:
