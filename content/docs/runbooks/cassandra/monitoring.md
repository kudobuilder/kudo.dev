...
[the monitoring directory](https://github.com/mesosphere/kudo-cassandra-operator/tree/master/monitoring).
...
match the
[labels on the `ServiceMonitor` resource](https://github.com/kudobuilder/operators/blob/master/repository/cassandra/3.11/operator/templates/service.yaml#L7)
